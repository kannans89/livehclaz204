...
class Program
{
    ...
    private const string connectionString = "Endpoint=sb://day5eventhub.servicebus.windows.net/;SharedAccessKeyName=SendAndReceive;SharedAccessKey=bK1MFky0J2CxFjT9iP37jakYuksBIw84P+AEhPbDWQM=;EntityPath=apphub";
